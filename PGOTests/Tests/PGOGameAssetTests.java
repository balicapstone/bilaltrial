...
public class PGOGameAssetTests {
	...
	public static void executeBefore(){
		...
		try{
			...
			user.getWatcher().TakeScreenshot("FailureToRunExecuteBeforeForPGOGameAssetTests");
		}
	...
	*/
	...
	public void testZoomAnimal(){
		...
		String picture = zoom.getCurrentPictureAssetLink();
		
		assertTrue("Asserts that the image of the first game board is valid", zoom.verifyAsset(picture));
