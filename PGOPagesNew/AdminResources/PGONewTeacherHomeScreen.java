...
public class PGONewTeacherHomeScreen extends PGONewBasePage{
	...
	private By[] InitialDistrictAdminElements = {logoutButton, articleViewsTab, articlePopularityTab,
			gamesTab, userAccessTab, subscriptionsTab, topContentTab};
	
	public PGONewTeacherHomeScreen(User u){
		user = u;
	...
	public By[] getInitialDistrictAdminElements(){
		return InitialDistrictAdminElements;
	}
	
	public PGONewDisableArticlesDatabasePage clickDisableArticlesButton(){
	...
	public PGONewLoginPage logout(){
		...
		pageDriver.get("https://"+user.getEnvironment()+".pebblego.com");
		PGONewLoginPage login = new PGONewLoginPage(pageDriver);
		
		return login;
	}
	
	public PGONewLoginPage clickPebbleGoLogo(){
		pageDriver.findElement(pebbleGoLogo).click();
		return new PGONewLoginPage(pageDriver);
	}
	
	public PGONewTeacherHomeScreen clickLinkAccountsTab(){
	...
	public PGONewTeacherLogin clickLinkAccountsButton(){
		...
		return new PGONewTeacherLogin(pageDriver);
	}
	
	public PGONewGooglePage clickGoogleAccountsButton(){
