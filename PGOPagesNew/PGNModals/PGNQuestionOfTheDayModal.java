...
public class PGNQuestionOfTheDayModal extends PGNBaseModal{
		...
		public PGNQuestionOfTheDayModal(WebDriver driver){
			super(driver);
		}
		
		public PGNQuestionOfTheDayModal clickAnswerByINT(int answer){
		...
		public PGNQuestionOfTheDayModal vote(){
			click(VoteButton);
			return this;
		}
