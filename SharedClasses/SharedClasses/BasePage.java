...
public class BasePage {
	...
	public BasePage sendKeysToElement(String keys, By by){
	...
	public ThirdPartyPage clickLink(By by){
		click(by);
	...
	public ThirdPartyPage navigateToLinkInSameTab(By by){
	...
	public JsonObject getArticleAssets(int i) throws ClientProtocolException, IOException{
		CloseableHttpClient client = HttpClientBuilder.create().build();
	...
	public JsonArray getArticlesFromModule(int i) throws ClientProtocolException, IOException{
		CloseableHttpClient client = HttpClientBuilder.create().build();
		HttpGet request = new HttpGet("https://pebblego.com/assets/module/" + i + "?sqs=fc60e391d07d9680077f1150481a0b5036eba2d037bb2708f107398217d0655a");
		HttpResponse response = client.execute(request);
	...
	public JsonObject getArticleAssets(String env, int i) throws ClientProtocolException, IOException{
		CloseableHttpClient client = HttpClientBuilder.create().build();
		HttpGet request = new HttpGet("https://"+ env +".pebblego.com/assets/article/" + i + "?sqs=$2y$10$O0S60.9z0G8xKmEIrQf46.tE9n6GA13xrx.qG5KFgH.yNvR8AqyHm");
		HttpResponse response = client.execute(request);
	...
	public String getLoggingSessionID(String loggingCall){
		...
		for(LogEntry l : logs){
			if(l.getMessage().contains(loggingCall) && l.getMessage().contains("session_id")){
				...
				sessionID = l.getMessage().substring(message.indexOf("\\\"session_id\\\":\\\"")+17, message.indexOf("\\\"state\\\":\\\"")-3);
