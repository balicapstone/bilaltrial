...
public class ScienceDatabaseHome extends DatabasePage{	
	...
	public ScienceDatabaseHome(WebDriver driver){
		super(driver);
	}
	...
	public ExperimentsPage goToExperimentsPage(){
		click(experimentsLink);
		return new ExperimentsPage(pageDriver);
	}
