...
public class DictionaryModal extends BaseModal{
	...
	public DictionaryModal(WebDriver driver){
		super(driver);
	}
	
	public DictionaryModal search(String text){
	...
	public DictionaryModal clickSuggestedWord(String suggested){
