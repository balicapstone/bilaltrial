...
public class DatabaseTests {
    ...
    public void testStatesQuestionOfTheDay(){
    	...
    	states.waitImplicitly(2);
    	home = (StudentHomePage) states.header.clickHomeBreadcrumb();
    }
    ...
    public void testScienceQuestionOfTheDay(){
    	...
    	home = (StudentHomePage) science.header.clickHomeBreadcrumb();
    }
    ...
    public void testIndiansQuestionOfTheDay(){
    	...
    	home = (StudentHomePage) indians.header.clickHomeBreadcrumb();
    }
    
    
    @Test
    public void testSocialStudiesQuestionOfTheDay(){
    	SocialStudiesDatabasePage social = home.goToSocialStudies();
    	...
    	home = (StudentHomePage) social.header.clickHomeBreadcrumb();
    }
    
    @Test
    public void testBiographiesQuestionOfTheDay(){
    	DatabasePage social = home.goToBiographies();
    	social.openQuestionOfTheDay();
    	social.waitImplicitly(2);
    ...
    public void testScienceExperimentVolcanoTranscript() throws InterruptedException{
    	...
    	VideoModal video = experiments.clickVideoByTitle("Volcano");
    ...
    public void testScienceExperimentMagnetismTranscript() throws InterruptedException{
    	...
    	VideoModal video = experiments.clickVideoByTitle("Magnetism");
    ...
    public void testScienceExperimentErosionTranscript() throws InterruptedException{
    	...
    	VideoModal video = experiments.clickVideoByTitle("Erosion");
    ...
    public void testScienceExperimentAirPressureTranscript() throws InterruptedException{
    	...
    	VideoModal video = experiments.clickVideoByTitle("Air Pressure");
    ...
    public void testScienceExperimentBubblingBlobsTranscript() throws InterruptedException{
    	...
    	VideoModal video = experiments.clickVideoByTitle("Bubbling Blobs");
    ...
    public void testScienceExperimentMonsterFoamTranscript() throws InterruptedException{
    	...
    	VideoModal video = experiments.clickVideoByTitle("Monster Foam");
    ...
    public void testScienceExperimentOceansAsAWaterSourceTranscript() throws InterruptedException{
    	...
    	VideoModal video = experiments.clickVideoByTitle("Oceans as a Water Source");
    ...
    public void testScienceExperimentBalloonRocketTranscript() throws InterruptedException{
    	...
    	VideoModal video = experiments.clickVideoByTitle("Balloon Rocket");
    ...
    public void testScienceExperimentTornadoInABottleTranscript() throws InterruptedException{
    	...
    	VideoModal video = experiments.clickVideoByTitle("Tornado in a Bottle");
    ...
    public void testHomeBreadcrumbScience(){
    	ScienceDatabaseHome science = home.goToScience();
    	science = (ScienceDatabaseHome) science.clickCategory("Earth Science");
    	science = (ScienceDatabaseHome) science.clickCategory("Geosphere");
    ...
    public void testBreadCrumbThirdLevel(){
    	ScienceDatabaseHome science = home.goToScience();
    	science = (ScienceDatabaseHome) science.clickCategory("Earth Science").clickCategory("Atmosphere").clickCategory("Weather and Climate");
